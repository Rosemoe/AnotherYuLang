...
public class Syso implements YulangCallable {

    public final static Syso INSTANCE = new Syso();
    ...
    public void invoke(YulangExecuteContext context, List<YulangParser.ArgumentContext> arguments, YulangParser.BlockStatementContext attachedStatement) {
        for (YulangParser.ArgumentContext argument : arguments) {
            System.out.println(context.getValueForExpression(argument.expression(), false));
        }
    }
